                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <Typography fontSize={"18px"}>
                                    SPORTSDAYが発行するクッキーをもとにして、Google inc.がお客様のSPORTSDAYへの訪問履歴を収集、記録、分析します。SPORTSDAY TEAMは、Google inc.からその分析結果を受け取り、お客様のSPORTSDAYへの訪問状況を把握します。
                                </Typography>
                                <Typography fontSize={"18px"}>
                                    Google Analyticsにより収集、記録、分析されたお客様の情報には、特定の個人を識別する情報は一切含まれません。また、それらの情報は、Google inc.により同社のプライバシーポリシーに基づいて管理されます。
                                </Typography>
