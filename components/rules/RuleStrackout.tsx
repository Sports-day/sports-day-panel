...
const markdown = `
# 📗ルール
- 制限時間内に大小15枚のフリスビーを用いて18枚のパネルを何枚打ち抜けるか競う。各クラスの1グループはさらにAとBにわかれる。
→1ゲームをAチーム、2ゲーム目をBチームが行う2ゲーム制とする。
- 先攻クラスAチーム→後攻クラスAチーム→先攻クラスBチーム→後攻クラスBチームの順で挑戦する。
- パネルまでの距離は5ｍとする。
→5ｍラインを越えてフリスビーを投げた場合、ペナルティとして獲得枚数を1枚減らす。
- 待ち時間は1チーム30秒とする。（前半・後半各30秒）
    ...
    return(
        ...
        >
            ...
            <Grid container>
                ...
                <Grid xs={6} sm={6} lg={3}>
                    <RuleNumCard title={"試合時間"} content={"晴天時:9分"} sub={"準備を含める"}/>
                </Grid>
                <Grid xs={6} sm={6} lg={3}>
                    <RuleNumCard title={"試合時間"} content={"雨天時:7分"} sub={"準備を含める"}/>
                </Grid>
                <Grid xs={6} sm={6} lg={3}>
