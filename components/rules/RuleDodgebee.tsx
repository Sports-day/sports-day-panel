...
- 初めの外野の人が最後まで残る場合は、内野人数としてカウントすることができない。
- 縦投げを禁止とする
    ...
    return(
        ...
        >
            ...
            <Grid container>
                ...
                <Grid xs={6} sm={6} lg={3}>
                    <RuleNumCard title={"試合時間"} content={"10分"} sub={"晴・雨天時"}/>
                </Grid>
                <Grid xs={6} sm={6} lg={3}>
                ...
                <Grid xs={12} sm={12} lg={12}>
                    <RuleNumCard title={"女子ハンデ"} content={"2回当たってよい"} sub={"女子は試合開始前にゼッケンを着用することとし、2回のヒットでアウトとなる。1回目のヒットではゼッケンを脱いで内野に留まり、2回目のヒットで外野へ移動する。ただし、外野から内野に戻った時はゼッケンを着ることはできない。"}/>
                </Grid>
            </Grid>
            <DialogContentText
